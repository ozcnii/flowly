...
| F03 | Find and inspect yoga content. | catalog/search/filter → workout/YouTube → favorite/play/materialize shared workout detail (DEC-063) | empty filters; cache fallback; unavailable YouTube with retry/alternative; UGC report/hide/block; restricted detail recovery | S-MA-020–025,S-MA-088 | [03](diagrams/03-yoga-discovery.md) |
...
| F09 | Inspect/correct calendar and reports. | month/week/day filters → detail → allowed status correction with confirm/history; weekly/monthly report with explicit Flowly/YouTube source cue → safe card | empty/loading/error/offline; current period `partial`; no-data explanation; card field consent; Monday/month-start 09:00 completed period; manual workout | S-MA-070–076,S-MA-044,S-BOT-006 | [09](diagrams/09-calendar-reports.md) |
