...
|---|---|---|---|---|---|
| F01 | Enter/auth/onboard/deep-link. Telegram context or browser URL. | validate initData → profile/timezone/preferences → mandatory bot gate → target/Home; create session/profile/settings | optional steps skipped; bot retry/diagnostics; invalid auth/outside Telegram; inaccessible target gives safe reason/recovery/exit | S-MA-001–006,S-MA-082,S-MA-096,S-BOT-001–002,S-WEB-001–002 | [01](diagrams/01-onboarding-auth.md) |
