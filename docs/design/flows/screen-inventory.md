...
| S-MA-020 | Йога: catalog | mobile-only shared Navbar `Йога` (web hidden); shared 16:9 WorkoutMediaCard/full titles; search/filter/source/favorite/open (DEC-043/047/050/053) | F03 | §12 | public/entitled content | partial: catalog |
...
| S-MA-022 | Workout detail | mobile-only internal Navbar `Тренировка` (web hidden); workout H1 above hero Card; inspect + visible disabled start/favorite/share; report/hide/author for UGC (DEC-047/048/051) | F03,F04,F10 | §13 | visibility checked; UGC warning | partial: detail |
