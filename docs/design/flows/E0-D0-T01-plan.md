...
- PRD §9 фиксирует пять вкладок; current display labels: Главная, Йога, Треки, Ритм, Дневник (domain sections Тренировки, Программы, Мой ритм, Календарь; DEC-045).
...
- Bot links ведут в конкретный целевой экран; `/app` — на Главную; `/help` удалён последующим DEC-041.
