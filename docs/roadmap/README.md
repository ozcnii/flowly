...
- **Следующее действие:** T08 (seed) → review (foundation-only, entity-seed на этапы 2–4); далее T09 (DoD gate) → T10 (profile).
...
| 1. Основа | in progress | 2 | 0 | 0 | 1 | 8 | [`01-foundation.md`](stages/01-foundation.md) |
...
**Итого:** 58 backlog / 0 in progress / 0 blocked / 1 review / 13 done.
