...
- **Активная задача:** E4-D5-T04 (недельная цель и интервальное расписание), `review` — model/API/UI, edit initialization race и atomic schedule replacement проверены локально.
- **Следующее действие:** user/real-device verification S-MA-062; после подтверждения закрыть T04. T05/T07 остаются downstream. E4-D5-T01/T02/T03 `done`.
...
| 4. Мой ритм | **active** | 4 | 0 | 0 | 1 | 3 | [`04-my-rhythm.md`](stages/04-my-rhythm.md) |
...
**Итого:** 36 backlog / 0 in progress / 1 blocked / 1 review / 41 done.
