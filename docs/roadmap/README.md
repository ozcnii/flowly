...
- **Активная задача:** none (E2-D3-T03 `blocked` / DEC-064 product defer).
- **Следующее действие:** pick next — E2-D3-T04 (manual log), stage polish, or residual S-MA-032 mixed. Own-workout constructor frozen until demand.
...
| 2. Йога | in progress | 2 | 0 | 1 | 0 | 10 | [`02-yoga.md`](stages/02-yoga.md) |
...
**Итого:** 50 backlog / 0 in progress / 1 blocked / 0 review / 27 done.
