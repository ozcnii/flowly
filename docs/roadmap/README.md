...
- **Следующее действие:** T07 (envs) done (deep review PASS); следующая foundation-задача **T08** (seed тестовых пользователей) → T09 (DoD gate) → T10 (profile).
...
| 1. Основа | in progress | 3 | 0 | 0 | 0 | 8 | [`01-foundation.md`](stages/01-foundation.md) |
...
**Итого:** 59 backlog / 0 in progress / 0 blocked / 0 review / 13 done.
