...
- **Активный этап:** 2. Йога (DoD closed; residual only).
- **Активная задача:** none.
- **Следующее действие:** optional residual **S-MA-032** mixed chooser; or start stage 3 (programs). Manual log only with calendar (E6-D7-T09). E2-D3-T03 own-workout stays `blocked` (DEC-064).
...
**Итого:** 48 backlog / 0 in progress / 1 blocked / 0 review / 29 done.  
\*Stage 2 DoD `done`; one residual blocked card E2-D3-T03 (own workouts, DEC-064) remains on the board.
