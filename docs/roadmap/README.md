...
- **Текущая задача:** E7-D8-T03 (review) — habit share UI (workouts N/A DEC-064).
- **Последняя закрытая задача:** E7-D8-T02 — remove friend + share revoke (edge 32/32).
- **Следующее действие:** user smoke T03 → done; then T04 joint programs or T05 challenges.
...
| 7. Социальные функции | in progress | 4 | 0 | 0 | 1 | 2 | [`07-social.md`](stages/07-social.md) |
| 8. Стабилизация | backlog | 8 | 0 | 0 | 0 | 0 | [`08-stabilization.md`](stages/08-stabilization.md) |

**Итого:** 12 backlog / 0 in progress / 1 blocked / 1 review / 65 done.
