...
- **Следующее действие:** T05 (R2) done (deep review PASS); следующая foundation-задача **T07** (local/test/prod environments) → T08 (seeds) → T09 (DoD gate) → T10 (profile).
...
| 1. Основа | in progress | 5 | 0 | 0 | 0 | 7 | [`01-foundation.md`](stages/01-foundation.md) |
...
**Итого:** 61 backlog / 0 in progress / 0 blocked / 0 review / 13 done.
