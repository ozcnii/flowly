...
- **Следующее действие:** начать E4-D5-T08 по утверждённым зависимостям и проверить DoD привычек.
...
| 4. Мой ритм | **active** | 1 | 0 | 0 | 0 | 7 | [`04-my-rhythm.md`](stages/04-my-rhythm.md) |
...
**Итого:** 32 backlog / 0 in progress / 1 blocked / 0 review / 45 done.
