...
> Обновлено: 2026-07-17 · Источник требований: [`../PRD.md`](../PRD.md)
...
- **Следующее действие:** E2-D2-T08 закрыта `done` после независимой re-verification (materialization idempotency, generated-detail DOM-matrix, /youtube 3-action card, occurrence→workout report-source join, UI-идентичность с user-reference workout, typecheck/lint/build PASS) и явного разрешения пользователя на commit+push. Следующий фокус — E2-D3-T02 (step/mixed session), который расширяет тот же DEC-062 `/sessions/[id]` runtime, не создавая параллельную session/player архитектуру.
...
| 2. Йога | in progress | 5 | 0 | 0 | 0 | 8 | [`02-yoga.md`](stages/02-yoga.md) |
...
**Итого:** 51 backlog / 1 in progress / 0 blocked / 0 review / 25 done.
