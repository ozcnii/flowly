...
- **Активная задача:** E3-D4-T02 `review` (enroll + start date).
- **Следующее действие:** user review Start→date→enrollment calendar; then T03 progress.
...
| 3. Программы | **active** | 6 | 0 | 0 | 0 | 1 | [`03-programs.md`](stages/03-programs.md) |
