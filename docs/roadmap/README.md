...
- **Следующее действие:** T08 (seed) done; следующая foundation-задача **T09** (security/DoD gate) → T10 (profile).
...
| 1. Основа | in progress | 2 | 0 | 0 | 0 | 9 | [`01-foundation.md`](stages/01-foundation.md) |
...
**Итого:** 58 backlog / 0 in progress / 0 blocked / 0 review / 14 done.
