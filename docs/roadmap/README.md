...
- **Следующее действие:** подготовить и согласовать deep plan T08 до реализации.
...
| 4. Мой ритм | **active** | 0 | 1 | 0 | 0 | 7 | [`04-my-rhythm.md`](stages/04-my-rhythm.md) |
...
**Итого:** 31 backlog / 1 in progress / 1 blocked / 0 review / 45 done.
