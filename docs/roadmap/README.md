...
- **Последняя закрытая задача:** E7-D8-T01 — invites/friendships (user smoke OK).
- **Следующее действие:** user smoke T02 → done; затем E7-D8-T03 habit share UI.
...
| 7. Социальные функции | in progress | 5 | 0 | 0 | 1 | 1 | [`07-social.md`](stages/07-social.md) |
| 8. Стабилизация | backlog | 8 | 0 | 0 | 0 | 0 | [`08-stabilization.md`](stages/08-stabilization.md) |

**Итого:** 13 backlog / 0 in progress / 1 blocked / 1 review / 64 done.
