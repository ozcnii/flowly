...
- **Следующее действие:** T10 (profile/help) in_progress; slice **S-MA-080** (profile hub) preview готов, ждёт approval → S-MA-090 (settings) → S-MA-096 (help).
...
| 1. Основа | in progress | 0 | 1 | 0 | 0 | 10 | [`01-foundation.md`](stages/01-foundation.md) |
...
**Итого:** 55 backlog / 1 in progress / 0 blocked / 0 review / 15 done.
