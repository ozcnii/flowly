...
> Обновлено: 2026-07-22 · Источник требований: [`../PRD.md`](../PRD.md)
...
- **Следующее действие:** user review T08 и подтверждение `review -> done`.
...
| 4. Мой ритм | **active** | 0 | 0 | 0 | 1 | 7 | [`04-my-rhythm.md`](stages/04-my-rhythm.md) |
...
**Итого:** 31 backlog / 0 in progress / 1 blocked / 1 review / 45 done.
