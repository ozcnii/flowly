...
- **Текущая задача:** E7-D8-T03 (in_progress) — habit share UI (workouts N/A DEC-064).
- **Последняя закрытая задача:** E7-D8-T02 — remove friend + share revoke (edge 32/32).
- **Следующее действие:** finish T03 habit share Sheet + shared read.
...
| 7. Социальные функции | in progress | 4 | 1 | 0 | 0 | 2 | [`07-social.md`](stages/07-social.md) |
| 8. Стабилизация | backlog | 8 | 0 | 0 | 0 | 0 | [`08-stabilization.md`](stages/08-stabilization.md) |

**Итого:** 12 backlog / 1 in progress / 1 blocked / 0 review / 65 done.
