...
- **Текущая задача:** E7-D8-T04 (backlog) — joint programs; T07 partner reminds + DoD.
- **Последняя закрытая задача:** E7-D8-T05/T06 challenges + reactions; T03 habit share.
- **Следующее действие:** T04 joint programs or T07 partner reminds + stage DoD.
...
| 7. Социальные функции | in progress | 2 | 0 | 0 | 0 | 5 | [`07-social.md`](stages/07-social.md) |
| 8. Стабилизация | backlog | 8 | 0 | 0 | 0 | 0 | [`08-stabilization.md`](stages/08-stabilization.md) |

**Итого:** 10 backlog / 0 in progress / 1 blocked / 0 review / 68 done.
