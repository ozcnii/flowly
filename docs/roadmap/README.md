...
- **Активный этап:** 3. Программы (stage 2 DoD closed).
- **Активная задача:** none — pick E3-D4-T01.
- **Следующее действие:** **E3-D4-T01** catalog программ (depends only E2-D2-T01 `done`). S-MA-032 **cancelled** DEC-066. E2-D3-T03 own-workout `blocked` DEC-064. Manual log E6-D7-T09.
...
| 3. Программы | **active** | 7 | 0 | 0 | 0 | 0 | [`03-programs.md`](stages/03-programs.md) |
