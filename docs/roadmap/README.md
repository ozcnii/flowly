...
- **Активная задача:** none (E2-D3-T03 `blocked` / DEC-064; E2-D3-T04 moved to E6 as E6-D7-T09 / DEC-065).
- **Следующее действие:** stage-2 — E2-D3-T05 DoD or residual S-MA-032. Manual log only with calendar (stage 6).
...
| 2. Йога | in progress | 0 | 0 | 1 | 1 | 10 | [`02-yoga.md`](stages/02-yoga.md) |
