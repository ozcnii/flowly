...
1. Review T03 progress on `/programs/enrollments/[id]` after finishing a same-day workout session.
2. Then T04 skip / T05 rest / T06 program occurrences as needed.
