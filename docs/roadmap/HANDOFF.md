...
- **Статус:** E4-D5-T01/T02/T03 `done`. E4-D5-T03 S-MA-062: migration 0017, schedule API, exact_times/weekdays config/validation/expansion, timezone picker и real-device TMA native time-picker interaction. План `.temp/E4-D5-T03/plan.md`; T03 не материализует occurrences, slot identity остаётся для T05/T07. Typecheck/build/local D1 migration PASS; production deploy `f0d84ab`, Actions `29843847723` PASS; user approval «очень круто».
