...
1. **E3-D4-T01** — каталог программ 7/14/30 (depends: E2-D2-T01 `done` only).
2. Chain: T01 → T02 start date → T03 progress → T04 skip → T05 rest → T06 occurrences → T07 jobs+DoD.
3. **Not now:** E2-D3-T03 (DEC-064); S-MA-032 (DEC-066 never); manual log E6-D7-T09; joint programs stage 7.
4. Report Badge `YouTube` remains E6.
