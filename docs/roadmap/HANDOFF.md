...
- **Активная задача:** none (stage 3 E3-D4 complete).
- **Статус:** T01–T07 `done`. T07: migration 0014 policies/jobs; materialize pending jobs on enroll/GET; cancel on skip/rest/finish; delivery deferred_to_stage_5; §55.3 DoD in `.temp/E3-D4-T07/dod-55.3.md` (joint → DEC-002/E7).
