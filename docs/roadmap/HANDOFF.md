...
- **Активная задача:** **E3-D4-T05** (`in_progress`).
- **Статус:** T01–T04 `done`. T04: `POST .../skip` → occurrence `skipped`, calendar fixed; user closed done + commit/push. Next T05 rest vs skip.
...
1. **E3-D4-T05** — planned rest days distinct from skip; progress/streak signal.
2. T06 program occurrences · T07 jobs+DoD.
