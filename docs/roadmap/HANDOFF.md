...
1. User review E3-D4-T02: program detail → Начать → date → enrollment days.
2. Close T02 then **E3-D4-T03** progress.
3. Prod: migration `0012` via CI; no seed for enrollments.
