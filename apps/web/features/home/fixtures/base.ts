...
/** Dev/scenario fixture only — production Home uses GET /api/v1/home. */
export const homeBase: HomeViewModel = {
  ...
  program: { title: "Гибкая спина", meta: "День 4 из 7", percent: 43, image: "/media/home-program.webp", href: "/programs" },
  habits: [
